...
// Based on https://github.com/opencv/opencv_contrib/blob/master/modules/aruco/samples/create_marker.cpp
...
namespace {
    ...
    "Example command: ./generateMarker -d=8 --id=10 --ms=500 \"marker.jpg\" --si";

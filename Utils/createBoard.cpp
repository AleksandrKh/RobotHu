...
// Based on: https://github.com/opencv/opencv_contrib/blob/master/modules/aruco/samples/create_board_charuco.cpp
...
namespace {
    ...
    "Example command: ./createBoard -d=8 -h=6 -w=8 --m=20 --ml=200 --sl=300 \"board.jpg\" --si";

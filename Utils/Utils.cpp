...
void Utils::printPoseVector(PoseVector poseVector) {
    ...
    cout << "Pose: Z distance: " + to_string(poseVector.zDistanceInMeters) + " X distance: " + to_string(poseVector.xDistanceInMeters) + "\n" << endl;
}

void Utils::printMotionVector(MotionVector motionVector) {
    
    cout << "Motion: angle: " + to_string(motionVector.angleInDeg) + " distance: " + to_string(motionVector.distanceInMeters) + "\n" << endl;
}
